...
namespace PrOnWeb.Data.Migrations
{
    ...
    [Migration("20211009085459_Update_211009_1")]
    partial class Update_211009_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrOnWeb.Data.Import_Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("Bad_Record_Count")
                        .HasColumnType("int");

                    b.Property<int>("Good_Record_Count")
                        .HasColumnType("int");

                    b.Property<DateTime>("Import_DateTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("Import_File_Name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Pr_Header_Count")
                        .HasColumnType("int");

                    b.Property<int>("Pr_Header_Id_Start")
                        .HasColumnType("int");

                    b.Property<int>("Pr_Item_Count")
                        .HasColumnType("int");

                    b.Property<int>("Pr_Item_Id_Start")
                        .HasColumnType("int");

                    b.Property<int>("Raw_Record_Count")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrOnWeb.Data.MatRegList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Mat_Group")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("MatRegLists");
                });
            ...
            modelBuilder.Entity("PrOnWeb.Data.PRHeader", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("PRHeader");
                });
            ...
            modelBuilder.Entity("PrOnWeb.Data.PRItem", b =>
                {
                    ...
                    b.Property<DateTime>("Item_close_date")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("Staff_assign_date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("PrOnWeb.Data.ReturningNote", b =>
                {
                    ...
                    b.Property<int>("Rn_By_Id")
                        .HasColumnType("int");

                    b.Property<string>("Rn_Id")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PrOnWeb.Data.RnPrItem", b =>
                {
                    b.Property<int>("Pr_Item_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrOnWeb.Data.PrListModel", b =>
                {
                    b.HasBaseType("PrOnWeb.Data.PRHeader");

                    b.Property<int>("Af_Version")
                        .HasColumnType("int");

                    b.Property<string>("Appr_Status")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("List_Level")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue("PrListModel");
                });
